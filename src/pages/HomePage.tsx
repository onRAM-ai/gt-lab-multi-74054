            ...
            <div className="grid lg:grid-cols-[1.2fr_1fr] gap-8 lg:gap-12 items-start">
              ...
              <div className="relative z-10 text-center lg:text-left animate-fade-in">
                <h1 className="text-5xl md:text-7xl lg:text-8xl font-black text-gray-900 mb-6 leading-tight">
                  ...
                  <span className="block mt-8 md:mt-12 lg:mt-16 text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-secondary animate-gradient-x">
                ...
                <div className="flex flex-wrap justify-center lg:justify-start gap-4 mb-8">
                  {['Australian Standards Compliant', 'High Quality Testing', 'Personal Service', 'Reliable Results'].map((feature, index) => (
                    <span
                      key={index}
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col sm:flex-row gap-4 animate-fade-in delay-500">
                  <Link
                    to="/contact"
                    className="group relative inline-flex items-center justify-center px-6 py-4 bg-gradient-to-r from-primary via-accent to-primary text-white font-bold rounded-xl shadow-2xl hover:shadow-primary/25 transform hover:scale-105 transition-all duration-300 overflow-hidden"
                  >
