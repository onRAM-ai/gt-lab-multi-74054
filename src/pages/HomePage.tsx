  ...
  return <div className="min-h-screen">
      ...
      <main>
        ...
        <section className="relative flex justify-center overflow-hidden bg-gradient-to-br from-slate-50 via-white to-gray-100">
          ...
          <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16 lg:pb-24 pt-16">
            {/* Centered Content */}
            <div className="text-center animate-fade-in">
              <h2 className="text-5xl md:text-6xl lg:text-7xl font-black mb-6 leading-tight">
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-primary via-accent to-secondary animate-gradient-x my-0 py-[10px]">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center animate-fade-in delay-500">
                <Link to="/contact" className="group relative inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-primary via-accent to-primary text-white font-bold rounded-xl shadow-2xl hover:shadow-primary/25 transform hover:scale-105 transition-all duration-300 overflow-hidden">
              ...
              <div className="flex justify-center mt-16 animate-fade-in delay-700">
                <div className="relative group">
                  ...
                  <div className="absolute inset-0 border-4 border-gradient-to-r from-primary/50 to-transparent rounded-full group-hover:animate-spin" style={{
                  animationDuration: '10s'
                }}></div>
                  
                  <img src={gtLabLogo} alt="Goldfields Testing Laboratory Logo" className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 object-contain drop-shadow-2xl group-hover:scale-110 transition-transform duration-500 animate-float-once" />
